...
const contractABI = require("../artifacts/contracts/Awesomezkproofs.sol/Awesomezkproofs.json").abi;

program
    .name("awesomezkproofs-cli")
    .description("CLI tool for Awesomezkproofs smart contract")
    .version("1.0.0");
